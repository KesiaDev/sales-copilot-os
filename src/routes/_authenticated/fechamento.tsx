  ...
  return (
    <>
      <Topbar
        ...
        subtitle="Resumo do final do expediente"
        showCurrencyToggle
      />
            ...
            >
              ...
              <div>
                ...
                <Input
                  ...
                  min={0}
                  step="0.01"
                  value={form.valor_vendido}
                  onChange={(e) => setForm({ ...form, valor_vendido: Number(e.target.value) })}
                />
              </div>
              ...
              <div className="col-span-2 md:col-span-3">
                ...
                <Textarea
                  rows={2}
                  value={form.principais_objecoes}
                  onChange={(e) => setForm({ ...form, principais_objecoes: e.target.value })}
                />
              </div>
              <div className="col-span-2 md:col-span-3">
                ...
                <Textarea
                  rows={2}
                  value={form.principais_dificuldades}
                  onChange={(e) => setForm({ ...form, principais_dificuldades: e.target.value })}
                />
              </div>
              <div className="col-span-2 md:col-span-3">
                <Label>Próximas oportunidades</Label>
                <Textarea
                  rows={2}
                  value={form.proximas_oportunidades}
                  onChange={(e) => setForm({ ...form, proximas_oportunidades: e.target.value })}
                />
              </div>
              <div className="col-span-2 flex items-center justify-between rounded-lg border border-border/60 p-3 md:col-span-3">
                ...
                <Switch
                  checked={form.precisa_ajuda}
                  onCheckedChange={(v) => setForm({ ...form, precisa_ajuda: v })}
                />
              </div>
              <div className="col-span-2 md:col-span-3">
              ...
              <div className="col-span-2 md:col-span-3">
                <Button type="submit" disabled={m.isPending || !form.profile_id} className="w-full">
                  Salvar fechamento
                </Button>
              </div>
            </form>
                ...
                {(reports ?? []).map((r: any) => (
                  <TableRow key={r.id}>
                    ...
                    <TableCell className="text-right text-xs font-medium">
                      {formatCurrency(r.valor_vendido)}
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
